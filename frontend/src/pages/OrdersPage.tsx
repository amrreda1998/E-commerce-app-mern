...
const OrdersPage = () => {
  ...
  if (loading) {
    return <Typography variant="body1" align="center">Loading orders...</Typography>;
  }

  if (orders.length === 0) {
    return <Typography variant="body1" align="center">No orders found.</Typography>;
  }
      ...
      <Box sx={{ maxWidth: 800, width: "100%" }}>
        ...
        {orders.map((order) => (
          ...
          >
            ...
            <Typography variant="body1">Shipping Address: {order.address}</Typography>
            ...
            <Box sx={{ marginTop: 2 }}>
              {order.orderItems.map((item, index) => (
                ...
                >
                  ...
                  <Typography variant="body1" sx={{ marginLeft: "auto", fontWeight: "bold" }}>
